            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-slate max-w-none">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-slate-600 mb-4">
                            TO THE MAXIMUM EXTENT PERMITTED BY LAW, CRUE360 SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
                        </p>
                        <p className="text-slate-600 mb-4">
